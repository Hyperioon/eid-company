define("xg/eid-company/1.0.0/c/lib/PIE_IE678-debug", [], function(require, exports, module) {
    (function(O, H) {
        var h = O.PIE || (O.PIE = {});
        h.Fa = function(a) {
        ...
        try {
            ...
            for (var a = 4, b = H.createElement("div"), d = b.getElementsByTagName("i"); b.innerHTML = "<!--[if gt IE " + ++a + "]><i></i><![endif]-->", d[0];);
            h.U = a;
        ...
        (function() {
            ...
            h.Q = {
                ...
                Ac: function(d, e, c) {
                    var g = b[d],
                        i, j;
                    if (g) Object.prototype.toString.call(g) === "[object Array]" ? g.push([e, c]) : e.call(c, g);
                    else {
                        j = b[d] = [
                            [e, c]
                        ];
        ...
        h.Pa.Ud = function() {
            var a = this,
                b;
            if (!a.Vd) {
                b = H.documentElement.currentStyle.getAttribute(h.z + "poll-interval") || 250;
                (function d() {
                    a.Da();
                    setTimeout(d, b)
                })();
            ...
            a.prototype = {
                Bd: function() {
                    if (!this.Rb) {
                        ...
                        if (g === 2) {
                            j & (c[0].h | c[1].h) && c[0].c in d && c[1].c in e && c.push(c.shift());
                            if (c[0].h & j)
            ...
            a.prototype = {
                ...
                jd: function() {
                    ...
                    if (b === undefined) {
                        ...
                        b = this.Rc = b === "deg" ? d : b === "rad" ? d / Math.PI * 180 : b === "grad" ? d / 400 * 360 : b === "turn" ? d * 360 : 0
                    }
                    return b
                }
            };
        ...
        h.Ic = function() {
            function a(f, k, l) {
                ...
                return 255 * (6 * l < 1 ? f + (k - f) * l * 6 : 2 * l < 1 ? k : 3 * l < 2 ? f + (k - f) * (2 / 3 - l) * 6 : f)
            }
            ...
            b.prototype = {
                ...
                rc: function(f, k, l) {
                    return "#" + (f < 16 ? "0" : "") + f.toString(16) + (k < 16 ? "0" : "") + k.toString(16) + (l < 16 ? "0" : "") + l.toString(16)
                },
                M: function(f) {
                    this.parse();
                    return this.tb === "currentColor" ? h.aa(f.currentStyle.color).M(f) : this.tb
                },
                Y: function() {
                    this.parse();
                    return this.Qc
            ...
            a.prototype = {
                ...
                next: function(d) {
                    ...
                    if (f = g.match(this.gc)) {
                        j = f[0];
                        this.ch += j.length;
                        if (j.toLowerCase() in h.Ic.db || j === "currentColor" || j === "transparent") return e(b.u, j);
                        if (g.charAt(j.length) === "(") {
                            this.ch++;
                            if (j.toLowerCase() in this.cd) {
                                ...
                                if ((j.charAt(0) === "r" ? f(m()) : g(m())) && l(m(), ",") && f(m()) && l(m(), ",") && f(m()) && (j === "rgb" || j === "hsa" || l(m(), ",") && g(m())) && l(m(), ")")) return e(b.u, this.$a.substring(i, this.ch));
                                return c()
                            }
                            return e(b.Mb, j)
                        }
        ...
        h.Hb = h.p.ba({
                    ...
                    for (g = {}; c = e.next();) {
                        ...
                        if (!g.V && l & i.Mb && m === "linear-gradient") {
                            ...
                            for (t = {}; c = e.next();) {
                                ...
                                if (l & k) {
                                ...
                                } else if (l & i.La && !q.la && !q.ab && !t.color && !q.ua.length) q.la = new h.Cc(c.c);
                                else if (l & i.W && m === "to" && !q.ab && !q.la && !t.color && !q.ua.length) {
                                    n = this.fe;
                                    u = this.Kd;
                                    c = e.va(function(r) {
                                    ...
                                    if (l < 1 || l > 2 || l > 1 && (c[0] in n && c[1] in n || c[0] in u && c[1] in u)) break;
                                    q.ab = c
                                } else if (l & j && m === ",") {
                                    if (t.color) {
                                        q.ua.push(t);
            ...
            T: h.p.oa(function() {
                return this.xb() || this.yc(function() {
                    var a = this.d.currentStyle,
                        b = this.fb;
                    return a[b.u] + " " + a[b.ia] + " " + a[b.ka] + " " + a[b.P + "X"] + " " + a[b.P + "Y"]
                })
            }),
            xb: h.p.oa(function() {
                var a = this.d;
            ...
            ic: function() {
                ...
                if (h.U < 7) {
                    a = this.d;
                    a = "" + (a.style[h.qb + "PngFix"] || a.currentStyle.getAttribute(h.z + "png-fix")) === "true"
                }
                return a
            },
            j: h.p.oa(function() {
        ...
        h.Jb = h.p.ba({
            ...
            T: h.p.oa(function() {
                var a = this.d,
                    b = a.currentStyle,
                    d;
                a.tagName in h.uc && a.offsetParent.currentStyle.borderCollapse === "collapse" || this.zc(function() {
        ...
        h.Ib = h.p.ba({
            ...
            ea: function(a) {
                ...
                if (a) {
                    ...
                    if (!b.src || !g || g.length < 1 || g.length > 4 || i && i.length > 4 || f === 1 && i.length < 1 || j && j.length > 4 || f === 2 && j.length < 1) return null;
                    ...
                    if (i && i[0]) b.O = a(i, function(n) {
                        return n.G() ? h.m(n.c) : n.c
                    });
                    if (j && j[0]) b.Ga = a(j, function(n) {
        ...
        h.Pc = function() {
            ...
            (function c() {
                try {
                    H.namespaces.add("pievml", "urn:schemas-microsoft-com:vml", "#default#VML")
                } catch (g) {
                    setTimeout(c, 1)
                }
            })();
            b.prototype = {
                ...
                zb: function() {
                    function c(m) {
                        if (m)
                            for (var o in m) m.hasOwnProperty(o) && i.push(" " + o + '="' + m[o] + '"')
                    }
        ...
        h.Fa(h.v, {
            ...
            Z: function(a, b, d, e, c, g) {
                a = this.$(a, b, d, e, c, g);
                return "m" + a[0] + "," + a[1] + "qy" + a[2] + "," + a[3] + "l" + a[4] + "," + a[5] + "qx" + a[6] + "," + a[7] + "l" + a[8] + "," + a[9] + "qy" + a[10] + "," + a[11] + "l" + a[12] + "," + a[13] + "qx" + a[14] + "," + a[15] + "x"
            },
            $: function(a, b, d, e, c, g) {
                ...
                if (g) {
                    ...
                    var o = g.x.tl * c,
                        ...
                        p = g.x.bl * c;
                    c = g.y.bl * c;
                    e = [i(e), i(k(m(s, a), f - d)), i(k(m(o, e), j - b)), i(a), l(m(e, j - m(q, b))), i(a), l(j - b), i(k(m(t, a), f - d)), l(j - b), l(m(a, f - m(u, d))), l(m(e, j - m(n, b))), l(f - d), i(k(m(p, e), j - b)), l(f - d), i(e), l(m(a, f - m(c, d)))]
                } else {
                    a = i(a);
                    b = l(j - b);
                    d = l(f - d);
            ...
            Bb: function() {
                var a = this.d,
                    ...
                    c = h.U === 6,
                    g;
                if (c && (e in h.Tb || e === "FIELDSET") || e === "BUTTON" || e === "INPUT" && a.type in h.Hd) {
                    d.borderWidth = "";
                    e = this.g.s.sc;
                    for (g = e.length; g--;) {
                        c = e[g];
                        d["padding" + c] = "";
                        d["padding" + c] = h.m(b["padding" + c]).a(a) + h.m(b["border" + c + "Width"]).a(a) + (h.U !== 8 && g % 2 ? 1 : 0)
                    }
                    d.borderWidth = 0
                } else if (c) {
            ...
            k: function() {
                var a = this.wb,
                    b;
                if (a)
                    for (b in a) a.hasOwnProperty(b) && this.Ba(b)
            }
        });
        h.Mc = h.v.sa({
            j: function() {
                var a = this.ad;
                for (var b in a)
                    if (a.hasOwnProperty(b) && a[b].j()) return true;
                return false
            },
            ac: function() {
                var a = this.ec(),
                ...
                return "direction:ltr;position:absolute;behavior:none !important;position:" + b + ";left:" + c + "px;top:" + g + "px;z-index:" + (e === "static" ? -1 : a.zIndex) + ";display:" + (i.xc && i.Vb ? "block" : "none")
            },
            vc: function() {
                var a = this.bc();
                ...
                if (this.j())
                    if (a)
                        if (b = this.vb) {
                            ...
                            if (d.xc && d.Vb) {
                                a.sort(this.Wd);
                                b = ['<css3pie id="_pie' + h.Q.pa(this) + '" style="' + this.ac() + '">'];
                                d = 0;
        ...
        h.Dc = h.v.sa({
            ...
            od: function() {
                ...
                if (a) {
                    ...
                    for (i = a.length; i--;) {
                        d = a[i];
                        e = this.B("bgImage" + i, this.H + (.5 - i / 1e3));
            ...
            Pd: function(a, b, d) {
                h.Q.Ac(b, function(e) {
                    ...
                    if (i && j) {
                        ...
                        k = this.vd(l.Ya);
                        c = l.ma ? l.ma.coords(c, m.f - f.f, m.e - f.e) : {
                            x: 0,
                            y: 0
                        };
                        l = l.bb;
                        var o = 0,
                            ...
                            t = j + 1,
                            n = h.U === 8 ? 0 : 1;
                        m = Math.round(k.x + c.x) + .5;
                        k = Math.round(k.y + c.y) + .5;
                        a.w("src", b, "position", m / i + "," + k / j, "size", f.f !== e.f || f.e !== e.e || g.jc !== 1 || screen.logicalXDPI / screen.deviceXDPI !== 1 ? h.Qa.gb(f.f) + "pt," + h.Qa.gb(f.e) + "pt" : "");
                        if (l && l !== "repeat") {
                            ...
                            a.Ha("clip", "rect(" + o + "px," + q + "px," + t + "px," + s + "px)")
                        }
                    }
                }, this)
            },
            $b: function(a, b) {
                ...
                return "m0,0r0,0m" + a.f * 2 + "," + a.e * 2 + "r0,0" + this.Z(d, e, c, g, 2)
            },
            vd: function(a) {
                var b = this.d,
                    d = this.g,
            ...
            Xc: function(a, b) {
                ...
                b = f.Jd;
                var l, m;
                for (c = k % 90 ? Math.atan2(f.be - f.rd, (f.qd - f.ae) * c / g) / j * 180 - 90 : -k; c < 0;) c += 360;
                c %= 360;
                g = [];
                j = [];
                for (f = 0; f < i; f++) j.push(e[f].lc ? e[f].lc.a(d, b) : f === 0 ? 0 : f === i - 1 ? b : null);
                for (f = 1; f < i; f++) {
                    if (j[f] === null) {
                        l = j[f - 1];
                        k = f;
                        do m = j[++k]; while (m === null);
                        j[f] = l + (m - l) / (k - f + 1)
                    }
                    j[f] = Math.max(j[f], j[f - 1])
                }
                for (f = 0; f < i; f++) g.push(j[f] / b * 100 + "% " + e[f].color.M(d));
                a.w("angle", c, "type", "gradient", "method", "sigma", "color", e[0].color.M(d), "color2", e[i - 1].color.M(d), "colors", g.join(","));
        ...
        h.Fc = h.v.sa({
            ...
            S: function(a, b, d, e, c, g, i) {
                ...
                if (i < d - b)
                    for (b += (d - b - i) / 2 % i; b < d;) {
                        j = Math.min(b + i, d);
                        a.push(g ? "m" + c + "," + b + "l" + c + "," + j + "l" + e + "," + j + "l" + e + "," + b + "x" : "m" + b + "," + c + "l" + j + "," + c + "l" + j + "," + e + "l" + b + "," + e + "x");
                        b += i * 2
                    }
            },
            wd: function() {
                ...
                if (a.j()) {
                    ...
                    if (c.ee && c.ed && !(a.t in this.Ub)) {
                        if (i.t.Y() > 0) {
                            ...
                            p = a.t;
                            if (p === "double") k.push(this.Z(j / 3, l / 3, m / 3, g / 3, 2) + this.Z(j * 2 / 3, l * 2 / 3, m * 2 / 3, g * 2 / 3, 2));
                            else if (p in u) {
                                c = this.$(j, l, m, g, 2);
                        ...
                        for (n in t)
                            if (t.hasOwnProperty(n) && i[n].Y() > 0) {
                                ...
                                var v = p[0],
                                    ...
                                    P = n === "t" || n === "l";
                                p = a[n];
                                k[0] = "al" + o[v] + "," + o[C] + "," + f(o[y] - o[v]) + "," + f(o[B] - o[C]) + "," + (w + 45) * 65535 + ",-2949075ae" + o[F] + "," + o[G] + "," + f(o[K] - o[F]) + "," + f(o[J] - o[G]) + "," + w * 65535 + ",-2949075";
                                if (p in this.md) {
                                    if (!s)
                                        if (p === "double") {
                                            s = this.$(j / 3, l / 3, m / 3, g / 3, 2);
                                            q = this.$(j * 2 / 3, l * 2 / 3, m * 2 / 3, g * 2 / 3, 2)
                                        } else s = q = this.$(j / 2, l / 2, m / 2, g / 2, 2);
                                    k.push("ae" + s[F] + "," + s[G] + "," + f(s[K] - s[F]) + "," + f(s[J] - s[G]) + "," + (w - 45) * 65535 + ",2949075ae" + s[v] + "," + s[C] + "," + f(s[y] - s[v]) + "," + f(s[B] - s[C]) + "," + w * 65535 + ",2949075x");
                                    if (p !== "double") {
                                        r = i[n].M(d) + ((p === "groove" ? P : !P) ? " darken(128)" : " lighten(128)");
                                        b.push(k.join(""), r);
                                        k.length = 0
                                    }
                                    k.push("al" + q[v] + "," + q[C] + "," + f(q[y] - q[v]) + "," + f(q[B] - q[C]) + "," + (w + 45) * 65535 + ",-2949075ae" + q[F] + "," + q[G] + "," + f(q[K] - q[F]) + "," + f(q[J] - q[G]) + "," + w * 65535 + ",-2949075")
                                }
                                k.push("ae" + c[F] + "," + c[G] + "," + f(c[K] - c[F]) + "," + f(c[J] - c[G]) + "," + (w - 45) * 65535 + ",2949075ae" + c[v] + "," + c[C] + "," + f(c[y] - c[v]) + "," + f(c[B] - c[C]) + "," + w * 65535 + ",2949075x");
                                if (p in u) n === "t" ? this.S(k, c[2], c[4], j * 2, 0, 0, p) : n === "r" ? this.S(k, c[7], c[9], l * 2, (e.f - l) * 2, 1, p) : n === "b" ? this.S(k, c[12], c[10], m * 2, (e.e - m) * 2, 0, p) : this.S(k, c[1], c[15], g * 2, 0, 1, p);
                                r = i[n].M(d);
                                if (p in this.Ub) r += (p === "groove" || p === "outset" ? P : !P) ? " lighten(128)" : " darken(128)";
                                b.push(k.join(""), r);
                                k.length = 0
                            }
                    }
                ...
                h.Q.Ac(a.src, function(c) {
                    function g(r, v, C, y, B, F, G, K, J) {
                        ...
                        if (!u || !p || !y || !B || !K || !J) r.Ha("display", "none");
                            ...
                            y = w(y, 0);
                            B = w(B, 0);
                            r.fa("path", "m0,0l" + y * 2 + ",0l" + y * 2 + "," + B * 2 + "l0," + B * 2 + "x");
                            r.w("src", n, "type", "tile", "position", "0,0", "origin", (F - .5) / u + "," + (G - .5) / p, "size", h.Qa.gb(y * u / K) + "pt," + h.Qa.gb(B * p / J) + "pt");
                            r.ta(y, B);
                    ...
                    g(this.N("c"), k, f, i - k - l, j - f - m, o, s, a.fill ? u - o - q : 0, p - s - t)
                }, this)
            },
            N: function(a) {
        ...
        h.Gc = h.v.sa({
            ...
            Ca: function() {
                ...
                for (var j, f, k, l, m, o, s, q, t, n; c--;) {
                    ...
                    f = this.B("shadow" + c, this.H + (.5 - c / 1e3));
                    if (o) {
                        t = (m + o) * 2 + i;
                        n = (m + o) * 2 + g;
                        m = t ? o * 2 / t : 0;
                        ...
                        f.w("type", "gradienttitle", "color2", j, "focusposition", m + "," + o, "focussize", 1 - m * 2 + "," + (1 - o * 2), "opacity", 0, "o:opacity2", s)
        ...
        h.Lc = h.v.sa({
            ...
            Ca: function() {
                ...
                a.fa("path", this.Z(i(c.t.a(e) + j.t.a(e)), i(c.r.a(e) + j.r.a(e)), i(c.b.a(e) + j.b.a(e)), i(c.l.a(e) + j.l.a(e)), 2));
                a.w("type", "frame", "src", g, "position", (d ? .5 / d : 0) + "," + (b ? .5 / b : 0));
                a.ta(d, b)
            },
            Ed: function() {
            ...
            function e(n) {
                function u() {
                    if (!T) {
                        ...
                        D.cb();
                        if (I && (z = D.n()) && (x = H.documentElement || H.body) && (z.y > x.clientHeight || z.x > x.clientWidth || z.y + z.e < 0 || z.x + z.f < 0)) {
                            if (!X) {
                                X = 1;
                                h.pb.ca(u)
                            }
                            ...
                            if (E === 9) {
                                ...
                                L = new h.Mc(n, D, A);
                                M = [new h.Gc(n, D, A, L), new h.Dc(n, D, A, L), new h.Fc(n, D, A, L), new h.Ec(n, D, A, L)];
