define("xg/eid-company/1.0.0/c/js/toolsSocket-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company/1.0.0/c/js/bootstrap-debug", "xg/eid-company/1.0.0/c/js/registerHelper-debug", "xg/eid-company/1.0.0/c/js/tools-debug", "xg/eid-company/1.0.0/c/js/jquery-debug.validate", "xg/eid-company/1.0.0/c/js/validate-add-methods-debug", "xg/eid-company/1.0.0/c/js/validate-messages-cn-debug", "xg/eid-company/1.0.0/c/js/moment-debug", "xg/eid-company/1.0.0/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/versionH-debug.handlebars", "alinw/handlebars/1.3.0/runtime-debug", "xg/eid-company/1.0.0/c/handlebars/confirm-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/validateMobile-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/confirm4mobile2-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/confirm4mobile-debug.handlebars"], function(require, exports, module) {
    ...
    var confirmTmp = require("xg/eid-company/1.0.0/c/handlebars/confirm-debug.handlebars");
    var companyId = "",
        interval = null,
        parentId = "",
        itemId = "",
    ...
    module.exports = {
        ...
        customerParentInit: function() {
            ...
            $("body").on("click", ".validateMobileBtn", function() {
                ...
                console.log("click");
                var validateMobileModal = require("xg/eid-company/1.0.0/c/handlebars/validateMobile-debug.handlebars");
            ...
            $("body").on("click", ".vMobileAgainToModalBtn", function() {
                ...
                console.log("click");
                var showCheckInfo = require("xg/eid-company/1.0.0/c/handlebars/showCheckInfo-debug.handlebars");
            ...
            $("body").on("click", "#sureValidateMobileBtn", function() {
                ...
                if (b) {
                    ...
                    console.log(data);
                    var modalConfirm4mobile = require("xg/eid-company/1.0.0/c/handlebars/confirm4mobile2-debug.handlebars");
            ...
            $("body").on("click", "#infoSureToModalBtn", function() {
                ...
                if (b) {
                    ...
                    $("#tip1").remove();
                    var modalConfirm4mobile = require("xg/eid-company/1.0.0/c/handlebars/confirm4mobile-debug.handlebars");
...
define("xg/eid-company/1.0.0/c/handlebars/confirm-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.0/c/handlebars/validateMobile-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
        ...
        buffer += escapeExpression(stack1) + '">重新查询</a>\r\n                    <a class="btn btn-primary h42 pull-right"  href="/cycle/credit/detail/detailPage.htm?encryptKey=';
        if (helper = helpers.encryptKey) {
            stack1 = helper.call(depth0, {
                hash: {},
                data: data
...
define("xg/eid-company/1.0.0/c/handlebars/confirm4mobile2-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.0/c/handlebars/confirm4mobile-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
