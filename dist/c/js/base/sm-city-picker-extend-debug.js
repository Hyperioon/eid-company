define("xg/eid-company/1.0.0/c/js/base/sm-city-picker-extend-debug", ["xg/eid-company/1.0.0/"], function(require, exports, module) {
    + function($) {
        "use strict";
        var area = require("xg/eid-company/1.0.0/");
        var china = [],
            p = area.getProvince(),
            c = [];
