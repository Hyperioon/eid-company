define("xg/eid-company/1.0.0/p/report/report-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company/1.0.0/c/js/tools-debug", "xg/eid-company/1.0.0/c/js/bootstrap-debug", "xg/eid-company/1.0.0/c/js/jquery-debug.validate", "xg/eid-company/1.0.0/c/js/validate-add-methods-debug", "xg/eid-company/1.0.0/c/js/validate-messages-cn-debug", "xg/eid-company/1.0.0/c/js/moment-debug", "xg/eid-company/1.0.0/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/versionH-debug.handlebars", "xg/eid-company/1.0.0/c/js/registerHelper-debug", "alinw/handlebars/1.3.0/runtime-debug", "xg/eid-company/1.0.0/p/report/plscan-debug.handlebars", "xg/eid-company/1.0.0/p/report/courtList-debug.handlebars", "xg/eid-company/1.0.0/p/report/clBehavior-debug.handlebars", "xg/eid-company/1.0.0/p/report/pawnList-debug.handlebars", "xg/eid-company/1.0.0/p/report/badBehavior-debug.handlebars", "xg/eid-company/1.0.0/p/report/badBehaviorList-debug.handlebars", "xg/eid-company/1.0.0/p/report/consumeBehavior-debug.handlebars", "xg/eid-company/1.0.0/p/report/communicationTrack-debug.handlebars"], function(require, exports, module) {
    ...
    var main = {
        init: function() {
            var self = this;
            self.url = {
                plScan: "/cycle/credit/detail/threeLeve/courtList.json",
                clBehavior: "/cycle/credit/detail/creditAction.json",
                clBehaviorPawnList: "/cycle/credit/detail/threeLeve/pawnList.json",
                badBehavior: "/cycle/credit/detail/threeLeve/badActionList.json",
                consumeBehavior: "/cycle/credit/detail/costAction.json",
                communicationTrack: "/cycle/credit/detail/phoneTrail.json"
            };
        ...
        getPlScan: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data.obj;
                    console.log(data);
                    var temp = require("xg/eid-company/1.0.0/p/report/plscan-debug.handlebars");
                    ...
                    console.log("-----------13-------------------------------------------");
                    var courtListTmp = require("xg/eid-company/1.0.0/p/report/courtList-debug.handlebars");
        ...
        getClBehavior: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data.obj;
                    console.log(obj);
                    var temp = require("xg/eid-company/1.0.0/p/report/clBehavior-debug.handlebars");
                    $("#reportBox").append(temp());
        ...
        getPawnList: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    console.log(data);
                    if (data.code == 0) {
                        var temp = require("xg/eid-company/1.0.0/p/report/pawnList-debug.handlebars");
        ...
        getBadBehavior: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data.obj;
                    console.log(obj);
                    var temp = require("xg/eid-company/1.0.0/p/report/badBehavior-debug.handlebars");
                    $("#reportBox").append(temp());
                    var list = require("xg/eid-company/1.0.0/p/report/badBehaviorList-debug.handlebars");
        ...
        getConsumeBehavior: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data.obj;
                    console.log(obj);
                    var temp = require("xg/eid-company/1.0.0/p/report/consumeBehavior-debug.handlebars");
                    $("#reportBox").append(temp());
        ...
        getCommunicationTrack: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var obj = data.obj;
                    console.log(obj);
                    var temp = require("xg/eid-company/1.0.0/p/report/communicationTrack-debug.handlebars");
                    $("#reportBox").append(temp());
        ...
        getPlScan1: function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var breakLaw = obj["breakLaw"];
                    $("#breakLaw").html(breakLaw);
                    var courtList = require("xg/eid-company/1.0.0/p/report/courtList-debug.handlebars");
...
define("xg/eid-company/1.0.0/p/report/plscan-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.0/p/report/courtList-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program2(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + "</td>\r\n            <td>" + escapeExpression((helper = helpers.getLocalTime1 || depth0 && depth0.getLocalTime1, options = {
                hash: {},
                data: data
            }, helper ? helper.call(depth0, depth0 && depth0.regDate, options) : helperMissing.call(depth0, "getLocalTime1", depth0 && depth0.regDate, options))) + '</td>\r\n            <td><span class="ellipsis">' + escapeExpression((helper = helpers.setNull || depth0 && depth0.setNull, options = {
                hash: {},
                data: data
...
define("xg/eid-company/1.0.0/p/report/pawnList-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.0/p/report/badBehaviorList-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
