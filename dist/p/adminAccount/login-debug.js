define("xg/eid-company/1.0.0/p/adminAccount/login-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company/1.0.0/c/js/tools-debug", "xg/eid-company/1.0.0/c/js/bootstrap-debug", "xg/eid-company/1.0.0/c/js/jquery-debug.validate", "xg/eid-company/1.0.0/c/js/validate-add-methods-debug", "xg/eid-company/1.0.0/c/js/validate-messages-cn-debug", "xg/eid-company/1.0.0/c/js/moment-debug", "xg/eid-company/1.0.0/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company/1.0.0/c/handlebars/versionH-debug.handlebars", "xg/eid-company/1.0.0/p/adminAccount/loginH-debug.handlebars"], function(require, exports, module) {
    ...
    var loginH = require("xg/eid-company/1.0.0/p/adminAccount/loginH-debug.handlebars");
    var main = {
        init: function() {
            var self = this;
            $("header h2").html("信鸽身份标识系统 v1.0");
            $("header").after(loginH());
                ...
                submitHandler: function(form) {
                    $.ajax({
                        ...
                        success: function(data, status, xhr) {
                            if (data.indexOf("<") != -1) {
                                window.location.href = "/company/customerManage.htm"
                            } else {
...
define("xg/eid-company/1.0.0/p/adminAccount/loginH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
