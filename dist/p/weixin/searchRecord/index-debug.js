define("xg/eid-company/1.0.0/p/weixin/searchRecord/index-debug", ["xg/eid-company/1.0.0/c/js/base/zepto-debug", "xg/eid-company/1.0.0/c/js/toolsWX-debug", "xg/eid-company/1.0.0/c/js/jquery-debug", "xg/eid-company/1.0.0/c/handlebarsWX/confirm-debug.handlebars", "xg/eid-company/1.0.0/p/weixin/searchRecord/item-debug.handlebars", "xg/eid-company/1.0.0/c/handlebarsWX/noData-debug.handlebars"], function(require, exports, module) {
    require("xg/eid-company/1.0.0/c/js/base/zepto-debug");
    var Tools = require("xg/eid-company/1.0.0/c/js/toolsWX-debug");
    var itemTmp = require("xg/eid-company/1.0.0/p/weixin/searchRecord/item-debug.handlebars");
    var noDataTmp = require("xg/eid-company/1.0.0/c/handlebarsWX/noData-debug.handlebars");
    module.exports = {
        init: function() {
            var self = this;
            self.pageSize = 10;
...
define("xg/eid-company/1.0.0/c/js/base/zepto-debug", [], function(require, exports, module) {
    var Zepto = function() {
...
define("xg/eid-company/1.0.0/c/js/toolsWX-debug", ["xg/eid-company/1.0.0/c/js/jquery-debug", "xg/eid-company/1.0.0/c/handlebarsWX/confirm-debug.handlebars"], function(require, exports, module) {
    require("xg/eid-company/1.0.0/c/js/jquery-debug");
    module.exports = {
        ...
        confirmBox: function(msg) {
            console.log("msg:");
            console.log(msg);
            var confirmTmp = require("xg/eid-company/1.0.0/c/handlebarsWX/confirm-debug.handlebars");
            ...
            for (var i = 0; i < substring.length; i++) {
                ...
                if (55296 <= hs && hs <= 56319) {
                    if (substring.length > 1) {
                        ...
                        var uc = (hs - 55296) * 1024 + (ls - 56320) + 65536;
        ...
        inputResize: function(filterSelector) {
            $("input, textarea").not(filterSelector).unbind("focus").on("focus", function(e) {
                setTimeout(function() {
                    var elementTop = $(e.target).offset().top,
...
(function(window, undefined) {
    ...
    if (typeof define === "function" && define.amd && define.amd.jQuery) {
        define("xg/eid-company/1.0.0/c/js/jquery-debug", [], function() {
            return jQuery
        })
    }
})(window);
define("xg/eid-company/1.0.0/c/handlebarsWX/confirm-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
...
define("xg/eid-company/1.0.0/p/weixin/searchRecord/item-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.0/c/handlebarsWX/noData-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
        helpers = this.merge(helpers, Handlebars.helpers);
        data = data || {};
        return '<div class="errorDiv" id="errorDiv">\r\n    <img src="http://static.hpbanking.com/xg/uploads/files/249168b4d413b1368100a8e184f7821e-128-128.png">\r\n    <div class="errorTip">暂无记录</div>\r\n</div>'
    })
});